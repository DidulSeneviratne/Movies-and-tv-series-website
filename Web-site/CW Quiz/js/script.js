...
let option1 = document.querySelector("#a");
let option2 = document.querySelector("#b");
let option3 = document.querySelector("#c");
let option4 = document.querySelector("#d");
...
let choice_que = document.querySelectorAll("li");
...
continueBtn.addEventListener("click", () => {
    ...
    total_correct.innerHTML = `${correct = 0} Out Of ${MCQS.length} correct answers`;
});
...
next_question.addEventListener("click", () => {
    ...
    if (index !== MCQS.length - 1) {
        ...
        total_correct.innerHTML = `${correct} Out Of ${MCQS.length} correct answers`;
        clearInterval(interval);
        interval = setInterval(countDown, 1000);
    } else {
        index = 0;
